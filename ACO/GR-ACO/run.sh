...
do
	...
	do     
		...
		if $BwlfCluster ; then
			...
			./experiment.sh $BwlfCluster $experiment $Total_nodes $Number_of_VMs_per_Nodes $vertex_degree $duplicating $Num_Ants $Iter_Global $Iter_Local $Instances_FileName $Number_of_Erlang_Nodes $pin $Separate_Master_and_Starter $Run_chaos;
			cd ..
			rm -rf bwlf_Nodes_*
		else
			...
			sbatch $Experiment_name $BwlfCluster $experiment $Total_nodes $Number_of_VMs_per_Nodes $vertex_degree $duplicating $Num_Ants $Iter_Global $Iter_Local $Instances_FileName $Number_of_Erlang_Nodes $pin $Separate_Master_and_Starter $Run_chaos;
		fi
